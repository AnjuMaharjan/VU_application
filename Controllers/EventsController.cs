...
namespace VU.Controllers
{
    public class EventsController : Controller
    {
        ...
        {
            ViewBag.OrganizerID = new SelectList(db.Organizers, "OrganizerID", "OrganizerName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "EventID,OrganizerID,EventName,EventLocation,StartTime,EndTime")] Event @event)
        {
            ...
            ViewBag.OrganizerID = new SelectList(db.Organizers, "OrganizerID", "OrganizerName", @event.OrganizerID);
            return View(@event);
        }
